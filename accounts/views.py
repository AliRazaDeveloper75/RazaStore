...
def dashboard(request):
    ...
    total_orders = Order.objects.order_by('-created_at').filter(user_id=request.user.id)
    pending_orders = Order.objects.order_by('-created_at').filter(user_id=request.user.id, is_ordered=False)
