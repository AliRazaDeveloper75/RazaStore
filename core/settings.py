...
EMAIL_USE_TLS = True
EMAIL_PORT= 587 
EMAIL_HOST_USER= 'aliraza.hope3@gmail.com'
EMAIL_HOST_PASSWORD = 'ddmqkbthytbsktpb'
# EMAIL_HOST_USER = os.environ.get('aliraza.hope3@gmail.com')
# EMAIL_HOST_USER = os.environ.get('ecommerce_app')
# EMAIL_HOST_PASSWORD = os.environ.get('ddmqkbthytbsktpb')
